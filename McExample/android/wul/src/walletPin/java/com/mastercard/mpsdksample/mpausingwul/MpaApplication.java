...
import com.mastercard.mpsdk.walletusabilitylayer.config.TransactionCounter;
...
public class MpaApplication extends BaseWulApplication {
    ...
    public void init() {
        ...
        TransactionCounter sharedCounter = new TransactionCounter("counter_1");
        ...
        TransactionPolicy lvtPolicy = new TransactionPolicy(TransactionPolicy.Type.LVT)
                ...
                .numberOfTransactionsAllowedBeforeAuth(TransactionPolicy.INFINITE)
                .secondsAllowedSinceLastAuth(TransactionPolicy.INFINITE)
                .withTransactionCounter(sharedCounter);
        ...
        WalletConfiguration.Builder builder = new WalletConfiguration.Builder(this)
                ...
                .withUserAuthMode(UserAuthMode.WALLET_PIN)
